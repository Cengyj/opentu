...
1. Open Whistle and paste the contents of `mock-image-base64.rules` into the
   Rules editor.
2. Make sure HTTPS capture is enabled for `foropencode.com`.
3. In AITU, keep the image Base URL pointed at `https://foropencode.com/v1`
...
- If you use a non-default API host, replace `foropencode.com` in the rules.

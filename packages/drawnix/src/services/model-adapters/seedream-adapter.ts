...
const SEEDREAM_BINDING_CONTRACTS = [
  {
...
export const seedreamImageAdapter: ImageModelAdapter = {
  ...
  async generateImage(context, request: ImageGenerationRequest) {
    ...
    const binding = requireImageBinding(context, request, {
      adapterLabel: 'Seedream adapter',
      supportedBindings: SEEDREAM_BINDING_CONTRACTS,
    });
    ...
    const parseResponse = async () => {
      ...
      return { artifacts: parseOpenAIImageArtifacts(result) };
    };

export const OFFICIAL_GPT_IMAGE_GENERATION_REQUEST_SCHEMA =
  'openai.image.gpt-generation-json';

export const GPT_IMAGE_GENERATION_REQUEST_SCHEMAS = [
  OFFICIAL_GPT_IMAGE_GENERATION_REQUEST_SCHEMA,
] as const;

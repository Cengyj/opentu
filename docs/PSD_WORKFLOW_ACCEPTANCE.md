...
3. 确认窗口只显示 **参考图**、**提示词**、一个 **准备 PSD 分层/导出** 主按钮，以及“图像生成 / 思考拆层 / 源设置：Photoshop / 导出编辑”四段流程说明。
...
6. 上传原始海报或参考图，输入设计描述，点击 **准备 PSD 分层/导出**。
7. 确认状态显示 **PSD 工作流已启动**，并说明已排队同画布分层素材、保留原坐标和 Photoshop/PSD 导出元数据；不要出现“已下载/已生成原生 PSD”等假成功。

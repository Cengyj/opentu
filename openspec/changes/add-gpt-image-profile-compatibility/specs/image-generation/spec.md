...
#### Scenario: For GPT Image uses dedicated adapter ownership
...
- **THEN** the system SHALL route through the dedicated For GPT Image adapter boundary
- **AND** SHALL NOT hide For GPT-specific request translation inside the generic default adapter
